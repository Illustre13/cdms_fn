						...
						<ul className="relative font-semibold space-y-0.5 p-4 py-0">
							...
							<li className="menu nav-item">
								...
								>
									...
									<div
										className={
											currentMenu !== "forms" ? "rtl:rotate-90 -rotate-90" : ""
										}
									>
										<IconCaretDown />
									</div>
							...
							<li className="menu nav-item">
								...
								>
									...
									<div
										className={
											currentMenu !== "page" ? "rtl:rotate-90 -rotate-90" : ""
										}
									>
										<IconCaretDown />
									</div>
									...
									<ul className="sub-menu text-gray-500">
										...
										<li className="menu nav-item">
											...
											>
												...
												<div
													className={`${
														errorSubMenu ? "rtl:rotate-90 -rotate-90" : ""
							...
							<li className="menu nav-item">
								...
								>
									...
									<div
										className={
											currentMenu !== "auth" ? "rtl:rotate-90 -rotate-90" : ""
										}
									>
										<IconCaretDown />
									</div>
