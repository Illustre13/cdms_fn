						...
						<div className="max-w-[30rem] w-full bg-white shadow-[4px_6px_10px_-3px_#bfc9d4] rounded border border-white-light dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
							<div className="p-5 flex items-center flex-col sm:flex-row">
								...
								<div className="flex-1 ltr:sm:pl-5 rtl:sm:pr-5 text-center sm:text-left">
									...
									<span className="badge bg-cdms_primary rounded-full">
										4.5
									</span>
    ...
    <div className="max-w-[30rem] w-full bg-white shadow-[4px_6px_10px_-3px_#bfc9d4] rounded border border-white-light dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
        <div className="p-5 flex items-center flex-col sm:flex-row">
            ...
            <div className="flex-1 ltr:sm:pl-5 rtl:sm:pr-5 text-center sm:text-left">
                ...
                <p className="mb-2 text-white-dark">Manager</p>
                <span className="badge bg-cdms_primary rounded-full">4.5</span>
                <p className="font-semibold text-white-dark mt-4 sm:mt-8">
				...
				<div className="panel">
					...
					<div className="mb-5 flex items-center justify-center">
						<div className="max-w-[20rem] w-full bg-cdms_secondary shadow-[4px_6px_10px_-3px_#bfc9d4] rounded border border-white-light dark:border-0 dark:bg-cdms_secondary-dark-light dark:shadow-none p-5">
							<div className="text-black-light">
								...
								<div className="flex">
									...
									<div className="flex-1 ltr:pl-4 rtl:pr-4">
										<h5 className="text-white text-[15px] font-semibold mb-1">
											Luke Ivory
										</h5>
										<p>Manager</p>
									</div>
							...
							<div className="text-[#515365] dark:text-white-light">
								...
								<div className="flex">
									<div className="flex-1">
										<h5 className="text-[#3b3f5c] text-[15px] font-bold mb-1.5 dark:text-white-light">
											Luke Ivory
										</h5>
        ...
        <div className="text-[#515365] dark:text-white-light">
            ...
            <div className="flex">
				...
				<div className="panel">
					...
					<div className="mb-5 flex items-center justify-center">
						<div className="max-w-[20rem] w-full bg-cdms_primary shadow-[4px_6px_10px_-3px_#bfc9d4] rounded border border-white-light dark:border-0 dark:bg-cdms_primary-dark-light dark:shadow-none p-5">
							<div className="text-center font-semibold">
								<h5 className="text-white text-xl font-bold mb-5 dark:text-white-light">
									Rating
								</h5>
