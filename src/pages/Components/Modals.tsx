											...
											>
												<div className="flex min-h-screen items-start justify-center px-4">
													<Transition.Child
														...
														leaveTo="opacity-0 scale-95"
													>
														<Dialog.Panel className="panel my-8 w-full max-w-[300px] overflow-hidden rounded-lg border-0 bg-cdms_secondary p-0 text-black dark:bg-cdms_secondary dark:text-white-dark">
											...
											<div className="flex min-h-screen items-start justify-center px-4">
												<Dialog.Panel className="animate__animated animate__fadeIn panel my-8 w-full max-w-xl overflow-hidden rounded-lg border-0 py-1 px-4">
													...
													<Swiper
														...
														key={
															themeConfig.rtlClass === "rtl" ? "true" : "false"
														}
													>
                    ...
                    <div id="profile_modal" className="fixed inset-0 bg-[black]/60 z-[999] overflow-y-auto">
                        <div className="flex items-start justify-center min-h-screen px-4">
                            <Transition.Child
                                ...
                                leaveTo="opacity-0 scale-95"
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden max-w-[300px] w-full bg-cdms_secondary dark:bg-cdms_secondary my-8 text-black dark:text-white-dark">
