...
const KnowledgeBase = () => {
	...
	return (
		<div>
			<div className="relative rounded-t-md bg-cdms_primary-light bg-[url('/assets/images/knowledge/pattern.png')] bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
			...
			<h3 className="mb-8 text-center text-xl font-semibold md:text-2xl">
				Some common <span className="text-cdms_primary">questions</span>
			</h3>
