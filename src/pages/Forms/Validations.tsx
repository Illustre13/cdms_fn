										...
										>
											...
											{submitCount ? (
												errors.select ? (
													...
													<div className=" text-[#1abc9c] mt-1">
						...
						<div className="mb-5">
							...
							>
								...
								<div className="flex items-center cursor-pointer mt-1">
									...
									<label
										htmlFor="agree1"
										className="text-white-dark font-semibold mb-0"
									>
										Agree to terms and conditions
									</label>
								</div>
									...
									<Form className="space-y-5">
										<div className="grid grid-cols-1 md:grid-cols-3 gap-5">
											...
											>
												...
												{submitCount ? (
													errors.firstname ? (
														<div className="text-white bg-danger py-1 px-2 rounded inline-block">
															{errors.firstname}
														</div>
													) : (
														<div className="text-white bg-[#1abc9c] py-1 px-2 rounded inline-block">
															Looks Good!
														</div>
													)
												) : (
