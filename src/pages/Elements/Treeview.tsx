					...
					<div className="mb-5">
						<ul className="font-semibold">
							<li className="py-[5px]">
								...
								>
									<IconCaretDown
										className={`w-5 h-5 text-cdms_primary inline relative -top-1 ltr:mr-2 rtl:ml-2 ${
											treeview1.includes("css") && "rotate-180"
										}`}
									/>
									<IconFolder className="text-cdms_primary inline relative -top-1 ltr:mr-2 rtl:ml-2" />
									CSS
								</button>
								<AnimateHeight
									duration={300}
								...
								>
									<ul className="ltr:pl-14 rtl:pr-14">
										<li className="py-[5px]">
											<IconTxtFile className="w-4.5 h-4.5 text-cdms_primary inline ltr:mr-2 rtl:ml-2" />
											style.css
										</li>
									</ul>
								</AnimateHeight>
							...
							<li>
								...
								>
									{treeview2.includes("parent") ? (
										<IconFolderPlus className="text-cdms_primary inline relative -top-1 ltr:mr-2 rtl:ml-2" />
									) : (
										<IconFolderMinus className="text-cdms_primary inline relative -top-1 ltr:mr-2 rtl:ml-2" />
									)}
									Parent Node
								</button>
								<AnimateHeight
								...
								>
									<ul>
										...
										<li className="py-[5px] ltr:pl-7 rtl:pr-7">
											...
											>
												<ul>
													<li className="py-[5px] ltr:pl-7 rtl:pr-7 text-cdms_secondary">
														style.css
													</li>
												</ul>
											</AnimateHeight>
            ...
            <ul>
                ...
                <li className="py-[5px] ltr:pl-7 rtl:pr-7">
                    ...
                    <AnimateHeight duration={300} height={treeview2.includes('css') ? 'auto' : 0} easing="none">
                        <ul>
                            <li className="py-[5px] ltr:pl-7 rtl:pr-7 text-cdms_secondary">style.css</li>
                        </ul>
                    </AnimateHeight>
                </li>
                <li className="py-[5px] ltr:pl-7 rtl:pr-7">
                    ...
                    <AnimateHeight duration={300} height={treeview2.includes('js') ? 'auto' : 0} easing="none">
                        <ul>
                            <li className="py-[5px] ltr:pl-7 rtl:pr-7 text-cdms_secondary">script.js</li>
                        </ul>
                    </AnimateHeight>
                </li>
                <li className="py-[5px] ltr:pl-7 rtl:pr-7 text-cdms_secondary">index.html</li>
            </ul>
        </AnimateHeight>
    </li>
</ul>`}</pre>
