								...
								return (
									<div
										...
										className="bg-white dark:bg-[#1b2e4b] rounded-xl shadow-[0_0_4px_2px_rgb(31_45_61_/_10%)] p-3 flex items-center justify-between
                                         text-gray-500 font-semibold min-w-[625px] hover:text-cdms_primary transition-all duration-300 hover:scale-[1.01]"
									>
						...
						<form>
							<ClickAwayListener onClickAway={overlayClickAway}>
								...
								>
									...
									<button
										type="button"
										className={`text-dark/70 absolute ltr:right-1 rtl:left-1 inset-y-0 my-auto w-9 h-9 p-0 flex items-center justify-center peer-focus:text-cdms_primary ${
						...
						<form>
							<div className="relative border border-white-dark/20  w-full flex">
								<button
									...
									className="text-cdms_primary m-auto p-3 flex items-center justify-center"
								>
									<IconSearch className="mx-auto w-5 h-5" />
								</button>
								<input
...
<form>
    <div className="relative border border-white-dark/20  w-full flex">
        <button type="submit" placeholder="Let's find your question in fast way" className="text-cdms_primary m-auto p-3 flex items-center justify-center">
            <svg>...</svg>
        </button>
        <input
            type="text"
