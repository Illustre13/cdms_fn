	...
	return (
		<div>
			...
			<div className="dragndrop space-y-8">
				...
				{/* Icon change */}
				<div className="panel">
					<div className="font-semibold text-lg dark:text-white mb-5">
						Icon Change
					</div>
												...
												<div className="py-sm-2.5 sm:flex block ltr:md:text-left rtl:md:text-right text-center items-md-center">
													<div className="ltr:sm:mr-4 rtl:sm:ml-4">
														<img
															...
															className="w-11 h-11 rounded-lg mx-auto"
														/>
													</div>
													<div className="flex md:flex-row flex-col justify-between items-center flex-1">
														<div className="font-semibold md:my-0 my-3">
					...
					<div className="panel">
						...
						<div id="example11">
							<ReactSortable
								...
								setList={setGridDrag}
								animation={200}
								className="grid grid-cols-2 xs sm:grid-cols-4 md:grid-cols-8 gap-8 place-items-center"
							>
								{gridDrag.map((item) => {
									return (
										<div
						...
						<div>
							<ul id="example7">
								<ReactSortable
									...
									swap={true}
									swapThreshold={1}
									className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-2.5"
								>
									{swap.map((item) => {
										return (
