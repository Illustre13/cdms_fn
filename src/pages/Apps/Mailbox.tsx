					...
					<div className="flex flex-col h-full pb-16">
						...
						<PerfectScrollbar className="relative ltr:pr-3.5 rtl:pl-3.5 ltr:-mr-3.5 rtl:-ml-3.5 h-full grow">
							<div className="space-y-1">
								...
								>
									...
									<div className="bg-cdms_primary-light dark:bg-[#060818] rounded-md py-0.5 px-2 font-semibold whitespace-nowrap">
										{mailList &&
						...
						<div className="ltr:left-0 rtl:right-0 absolute bottom-0 p-4 w-full">
							...
							>
								...
								<div className="bg-cdms_primary-light dark:bg-[#060818] rounded-md py-1 px-2">
									<IconPlus />
								</div>
							</button>
						</div>
													...
													>
														<ul className="text-sm font-medium">
															<li>
																...
																>
																	<div className="w-2 h-2 rounded-full bg-cdms_primary ltr:mr-3 rtl:ml-3 shrink-0"></div>
																	Personal
																</button>
															</li>
															<li>
								...
								<div className="mt-4 md:flex-auto flex-1">
									<div className="flex items-center md:justify-end justify-center">
										...
										<button
											...
											className="bg-[#f4f4f4] rounded-md p-1 enabled:hover:bg-cdms_primary-light dark:bg-white-dark/20 enabled:dark:hover:bg-white-dark/30 ltr:mr-3 rtl:ml-3 disabled:opacity-60 disabled:cursor-not-allowed"
											onClick={() => {
												pager.currentPage--;
												searchMails(false);
											}}
										...
										<button
											...
											className="bg-[#f4f4f4] rounded-md p-1 enabled:hover:bg-cdms_primary-light dark:bg-white-dark/20 enabled:dark:hover:bg-white-dark/30 disabled:opacity-60 disabled:cursor-not-allowed"
											onClick={() => {
												pager.currentPage++;
												searchMails(false);
											}}
										...
										<div className="flex items-center justify-center space-x-3 rtl:space-x-reverse">
											...
											<Tippy content="Important">
												...
												>
													<IconBookmark
														bookmark={false}
														className={`w-4.5 h-4.5 rotate-90 ${
						...
						<div className="relative">
							...
							<form className="p-6 grid gap-6">
								...
								<div>
									<input
										type="file"
										className="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-cdms_primary/90 ltr:file:mr-5 rtl:file:ml-5 file:text-white file:hover:bg-cdms_primary"
										multiple
