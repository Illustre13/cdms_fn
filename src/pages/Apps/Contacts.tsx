					...
					<div className="flex gap-3">
						...
						<div>
							<button
								...
								className={`btn btn-outline-primary p-2 ${
									value === "list" && "bg-cdms_primary text-white"
								}`}
						...
						<div>
							<button
								type="button"
								className={`btn btn-outline-primary p-2 ${
									value === "grid" && "bg-cdms_primary text-white"
								}`}
											...
											<td>
												<div className="flex items-center w-max">
													...
													{!contact.path && contact.name && (
														<div className="grid place-content-center h-8 w-8 ltr:mr-2 rtl:ml-2 rounded-full bg-cdms_primary text-white text-sm font-semibold"></div>
													)}
													{!contact.path && !contact.name && (
