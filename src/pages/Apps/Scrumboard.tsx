...
const Scrumboard = () => {
	...
	const saveTask = () => {
		...
		const project: any = projectList.find(
			(d: any) => d.id === paramsTask.projectId
		);
		if (paramsTask.id) {
			//update task
									...
									<div className="flex justify-between mb-5">
										...
										<div className="flex items-center">
											<button
												...
												type="button"
												className="hover:text-cdms_primary ltr:mr-2 rtl:ml-2"
											>
												<IconPlusCircle />
											</button>
												...
												>
													<div className="shadow bg-[#f4f4f4] dark:bg-white-dark/20 p-3 pb-5 rounded-md mb-5 space-y-3 cursor-move">
														...
														<div className="flex items-center justify-between">
															<div className="font-medium flex items-center hover:text-cdms_primary">
															...
															<div className="flex items-center">
																...
																<button
																	onClick={() =>
																		deleteConfirmModal(project.id, task)
																	}
																	type="button"
